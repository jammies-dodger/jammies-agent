...
schema_get_file_content = {
    ...
    "function": {
        ...
        "description": "Read file contents, file specified relative to the working directory, providing the first 10000 characters of the file then truncates if the file is larger",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
